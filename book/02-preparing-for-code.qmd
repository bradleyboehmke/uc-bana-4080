# Setting Up Your Python Environment {#sec-preparing-for-code}
...
📓 We’ve created a [sample notebook](https://github.com/bradleyboehmke/uc-bana-4080/blob/main/notebooks/examples/02_first_notebook.ipynb) that introduces:
