...
* [**Appendix A: Installing Anaconda**](#)
* [**Appendix B: Setting Up VS Code for Python**](#)
...
* Follow the instructions in [Appendix A](#) to install Anaconda and launch JupyterLab.
...
* Follow the instructions in [Appendix B](#) to install VS Code and set up Python and Jupyter support.
