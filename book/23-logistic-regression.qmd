...
As you read through this chapter, we encourage you to follow along using the [companion notebook](https://github.com/bradleyboehmke/uc-bana-4080/blob/main/notebooks/examples/23_logistic_regression.ipynb) in Google Colab (or another editor of your choice). This interactive notebook lets you run all the code examples covered here—and experiment with your own ideas.

👉 Open the [Logistic Regression Notebook in Colab](https://colab.research.google.com/github/bradleyboehmke/uc-bana-4080/blob/main/notebooks/examples/23_logistic_regression.ipynb).
:::
...
## 🎥 Video Spotlight: Logistic Regression Explained

A simple introduction to logistic regression to help reinforce the concepts you just read!

{{< video https://youtu.be/yIYKR4sgzI8?si=-Fh2yCGZ6d9J7SSM >}}
:::
...
5. **Compare with balance**: Which is a stronger predictor of default—balance or income? How can you tell?
...
## 🎥 Video Spotlight: End-to-End Logistic Regression with Scikit-Learn
...
{{< video https://youtu.be/5FdavD4eU4g?si=iJOXSwJKfXdhoMgh >}}
:::
