...
As you read through this chapter, we encourage you to follow along using the [companion notebook](https://github.com/bradleyboehmke/uc-bana-4080/blob/main/notebooks/examples/31_clustering.ipynb) in Google Colab (or another editor of your choice). This interactive notebook lets you run all the code examples covered here—and experiment with your own ideas.

👉 Open the [Clustering Notebook in Colab](https://colab.research.google.com/github/bradleyboehmke/uc-bana-4080/blob/main/notebooks/examples/31_clustering.ipynb).
:::
...
ax.text((customer_a[0] + customer_b[0])/2 - 2, (customer_a[1] + customer_b[1])/2 + 3000,
        f'Distance ≈ {distance:,.0f}', ha='center', fontsize=11, fontweight='bold',
...
ax.set_ylabel('Contribution to Distance² (squared units)', fontsize=11, fontweight='bold')
...
# Add text annotation
ax.text(3.5, 0.5, 'Points are close to centroids ✓',
       ha='center', fontsize=11, fontweight='bold',
...
# Add text annotation
ax.text(3.5, 0.5, 'Points are spread out from centroids ✗',
       ha='center', fontsize=11, fontweight='bold',
