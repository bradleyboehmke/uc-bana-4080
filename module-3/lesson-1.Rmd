...
```{r final_recipe}
final_recipe <- recipe(Sale_Price ~ ., data = train) %>%
...
1. Rather than ordinal encode the quality and condition features, one-hot encode these features.
