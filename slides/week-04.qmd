...
## Intro Activity – Load the Data {.smaller .scrollable}

::: {.callout-important}
## Follow along

Open up Colab and load the Complete Journey data: [tinyurl.com/bana4080-wk4-lecture](https://tinyurl.com/bana4080-wk4-lecture)
:::
...
::: {.callout-note}
Complete Journey Docs: [completejourney_py](https://cunningjames.github.io/completejourney_py/)
:::
...
## 🧑‍💻 Code With Me: Clean Product Names {.smaller .scrollable}
...
## 🧑‍💻 Code With Me: Create Business Metrics {.smaller .scrollable}
...
## 🧑‍💻 Code With Me: Top Revenue Products {.smaller .scrollable}
...
## 🧑‍💻 Code With Me: Store Performance {.smaller}
...
## 🧑‍💻 Code With Me: Customer Demographics Analysis {.smaller .scrollable}
...
## 🧑‍💻 Code With Me: Family Spending Analysis {.smaller}
