...
subtitle: "Week 9: Correlation & Regression Foundations"
format:
  revealjs:
    self-contained: true
    slide-number: true
...
axes[0].set_title('Positive Correlation (r ≈ 0.7)', fontsize=12, fontweight='bold')
...
axes[1].set_title('No Correlation (r ≈ 0)', fontsize=12, fontweight='bold')
...
axes[2].set_title('Negative Correlation (r ≈ -0.7)', fontsize=12, fontweight='bold')
...
::: {.notes}
Emphasize that correlation ≠ causation. This is crucial for business decision-making.
:::
