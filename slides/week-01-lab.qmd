---
title: "Week 1 Lab"
subtitle: "BANA 4080: Introduction to Data Mining with Python"
format:
  revealjs:
    self-contained: true
    slide-number: true
...
::: {.callout-note}
📘 Based on Chapters [2](https://bradleyboehmke.github.io/uc-bana-4080/book/02-preparing-for-code.html) & [3](https://bradleyboehmke.github.io/uc-bana-4080/book/03-python-basics.html)  
:::
...
::: {.callout-tip}
See the [Anaconda Installation](https://bradleyboehmke.github.io/uc-bana-4080/book/99-anaconda-install.html) and/or [VS Code Installation](https://bradleyboehmke.github.io/uc-bana-4080/book/99-vscode-install.html) guide in the book appendix
:::
...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bradleyboehmke/uc-bana-4080/blob/main/labs/lab-01-intro.ipynb)
